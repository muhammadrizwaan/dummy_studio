...
class InProcessProvider extends ChangeNotifier{
  ...
  Future getInProcessLoad({@required BuildContext context, @required int pageNumber}) async{
    try{
      ...
      if(connectivityResult == ConnectivityResult.none){
        ...
        if(response.statusCode == 200){
          ...
          if(_loadsResponse.code == 1){
            _myJobsProvider.inProcessList.addAll(_loadsResponse.result.inProcess);
            isLoading = false;
            notifyListeners();
          }
          else{
